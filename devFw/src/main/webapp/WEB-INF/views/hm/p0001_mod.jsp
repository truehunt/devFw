...
<jsp:useBean  id="p0001VO"  class="project.hm.p0001.vo.P0001VO"  scope="request"/> 
<%
...
<title>Insert title here</title>
  <script type="text/javascript">
	function frm_update() {
		...
		frmPro.method = "post";
		frmPro.action = "${contextPath}/hm/p0001/updateMember.do"; 
		frmPro.submit();
	}
	...
	function frm_add() {
		var frmPro = document.frm;
		frmPro.method = "post";
		frmPro.action = "${contextPath}/hm/p0001/insertMember.do"; 
		frmPro.submit();
	}	
   </script>
</head>
